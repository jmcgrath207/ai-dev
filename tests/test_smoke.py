    ...
    def test_dry_run_runs_all_steps(self):
        ...
        proxies = {
            ...
            for name in [
                ...
                "configure_dcp_limits",
                "remove_openrouter_routing_cron",
                "install_superpowers",
        ...
        with _tf.TemporaryDirectory() as fake_home:
            with mock.patch.dict(os.environ, {"HOME": fake_home}), \
                ...
                with mock.patch.multiple(
                    ...
                    configure_dcp_limits=proxies["configure_dcp_limits"],
                    remove_openrouter_routing_cron=proxies["remove_openrouter_routing_cron"],
        ...
        with _tf.TemporaryDirectory() as fake_home:
            with mock.patch.dict(os.environ, {"HOME": fake_home}), \
                ...
                for name in [
                    ...
                    "configure_openrouter_routing", "configure_dcp_limits", "remove_openrouter_routing_cron",
